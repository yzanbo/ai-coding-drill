...
| Projects | ✅ 有効 | デフォルト通り |
| Allow forking | ✅ 有効 | public のデフォルト通り |
...
詳細仕様と設計理由は [ADR 0030: ci-success umbrella job](../../adr/0030-ci-success-umbrella-job.md) と [ADR 0031](../../adr/0031-github-repository-settings.md) を参照。
