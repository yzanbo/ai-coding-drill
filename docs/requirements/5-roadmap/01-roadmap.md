...
| R0-9 | Docker Compose（Postgres + Redis）+ Drizzle 初版 + マイグレーション基盤 | 🔴 次タスク | R0 完了の最終条件 → [ADR 0004](../../adr/0004-postgres-as-job-queue.md) / [ADR 0017](../../adr/0017-drizzle-orm-over-prisma.md) |
