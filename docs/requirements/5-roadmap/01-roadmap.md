...
| # | 項目 | 状態 | 理由 / 関連 |
|---|---|---|---|
| 1 | commitlint 導入 + scope/type 規約整備 | ✅ | 履歴ゲート。コミット履歴は遡及修正不可。設定の試行錯誤を hook 起動から切り離す |
| 2 | lefthook + commit-msg フック | 🔴 次タスク | commitlint を機械強制 |
| 3 | モノレポ枠（pnpm workspaces + Turborepo + `packages/config`）| 🔴 | 後続ツールの設定置き場 → [ADR 0012](../../adr/0012-turborepo-pnpm-monorepo.md) |
| 4 | Biome + lefthook の pre-commit 接続 | 🔴 | コード蓄積前にフォーマット規律 → [ADR 0013](../../adr/0013-biome-for-tooling.md) |
| 5 | GitHub Actions（min：commitlint + Biome + typecheck）| 🔴 | リモートで規約逸脱を弾く |
| 6 | Dependabot | 🔴 | 設定 1 ファイルで自動 PR |
| 7 | syncpack | 🔴 | パッケージ複数化前に整合性ゲート |
| 8 | Knip | 🔴 | 設定先行投入、export 蓄積で本領発揮 |
| 9 | Docker Compose（Postgres + Redis）+ Drizzle 初版 + マイグレーション基盤 | 🔴 | R0 完了の最終条件 → [ADR 0001](../../adr/0001-postgres-as-job-queue.md) / [ADR 0016](../../adr/0016-drizzle-orm-over-prisma.md) |
...
| # | 項目 | 状態 | 関連 |
|---|---|---|---|
| 10 | ジョブペイロード JSON Schema 確定 + TS/Go 型自動生成（shared-types パターン確立）| 🔴 | [ADR 0014](../../adr/0014-json-schema-as-single-source-of-truth.md) |
| 11 | [F-01: GitHub OAuth ログイン](../4-features/F-01-github-oauth-auth.md) | 🔴 | [ADR 0015](../../adr/0015-github-oauth-with-extensible-design.md) |
| 12 | LLM プロバイダ抽象化レイヤ + 初期モデル選定（実装着手時に確定 + ADR 起票）| 🔴 | [ADR 0011](../../adr/0011-llm-provider-abstraction.md) |
| 13 | [F-02: 問題生成リクエスト](../4-features/F-02-problem-generation.md)（同期版で先に成立）| 🔴 | [03-llm-pipeline.md](../2-foundation/03-llm-pipeline.md) |
| 14 | [F-03: 問題表示・解答入力](../4-features/F-03-problem-display-and-answer.md) | 🔴 | [ADR 0003](../../adr/0003-codemirror-over-monaco.md) |
| 15 | 採点ワーカー（Go）初版 + サンドボックス（Docker + 制限フラグ）| 🔴 | [ADR 0005](../../adr/0005-go-for-grading-worker.md) / [ADR 0008](../../adr/0008-disposable-sandbox-container.md) |
| 16 | [F-04: 自動採点](../4-features/F-04-auto-grading.md)（trace_id 連結を R1 から実装）| 🔴 | [ADR 0017](../../adr/0017-w3c-trace-context-in-job-payload.md) |
| 17 | [F-05: 学習履歴・統計](../4-features/F-05-learning-history.md) | 🔴 | — |
