...
| ADR | タイトル | キーワード |
|---|---|---|
| [0021](./0021-phase-0-tooling-discipline.md) | 補完ツール（Knip / lefthook / commitlint / syncpack）を R0 から導入 | YAGNI 例外条件 / 不可逆コスト膨張 |
...
6. **[0021: 補完ツールを R0 から導入](./0021-phase-0-tooling-discipline.md)** — 「遅延の不可逆性が高い判断には YAGNI を適用しない」というメタ方針の確立
